...
$em = $conexion->prepare('SELECT f.idfavorito, c.nombre, c.img, c.idpelicula  FROM favoritos f INNER JOIN contenidos c on f.idpelicula=c.idpelicula WHERE idusuario = :idusuario');
		...
		<main class="grid">
			...
			<a href="contenido.php?contenido=<?php echo $dato->idpelicula; ?>"> <img src="data:image;base64,<?php echo base64_encode($dato->img); ?>"></a>
				<div class="card-title ">
					...
					<a title='Quitar de mi lista' class="bi bi-trash delete" href="eliminardelista.php?idfavorito=<?php echo $dato->idfavorito; ?>"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">

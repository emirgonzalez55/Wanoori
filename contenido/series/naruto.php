...
<div class="mb-3 pelicula mensaje" style="max-width: 1052px;">
  <div class="row g-0">
    <div class="col-md-3">
      <img src="img/Naruto.jpg"  class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
      <h1>Naruto(1999)</h1>
      <p>Año: 1999</p>
      <p>Géneros: Animación Comedia Action & Adventure </p>
      <h4>sinopsis:</h4>
...
<iframe width="100%" height="100%" src="https://www.youtube.com/embed/-G9BqkgZXRA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

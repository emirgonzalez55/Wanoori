...
<div class="mb-3 pelicula mensaje" style="max-width: 1052px;">
  <div class="row g-0">
    <div class="col-md-3">
      <img src="img/Regresoalfuturo.jpg"  class="img-fluid rounded-start img-fluid" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
      <h1>Regreso al futuro (1985)</h1>
      <p>Año: 1985</p>
...
<iframe width="100%" height="100%" src="https://www.youtube.com/embed/q27OhNUzBXk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
</html>

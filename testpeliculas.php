    ...
    <main class="grid">
      <article class="text-white bg-dark mb-3 ">
        ...
        <div class="card-title ">
          ...
          <a class="bi bi-plus-circle plus " href="agregaralista.php?idpelicula=<?php echo $dato->idpelicula; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
